...
class _ShoppingCartScreenState extends State<ShoppingCartScreen> {
                              ...
                              children: [
                                Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl:
                                          "https://itschizo.com/wedeliver/foodimages/${cartList[index]['imagename']}.jpg",
                                      fit: BoxFit.cover,
  ...
  _loadFoodDetails(int index) async {
    Food curfood = new Food(
        ...
        fooddesc: cartList[index]['fooddesc'],
  ...
  void _loadCart() {
    http.post("https://itschizo.com/wedeliver/php/load_cart.php", body: {
      ...
      if (res.body == "nodata") {
        ...
        setState(() {
          ...
          lat = double.parse(cartList[0]['lat']);
          lon = double.parse(cartList[0]['lon']);
          del = double.parse(cartList[0]['del']);
          _calculatePayment();
        });
      }
    }).catchError((err) {
  ...
  void _deleteCart(int index) {
    http.post("https://itschizo.com/wedeliver/php/delete_cart.php", body: {
      "email": widget.user.email,
      "foodid": cartList[index]['foodid'],
    }).then((res) {
      print(res.body);
