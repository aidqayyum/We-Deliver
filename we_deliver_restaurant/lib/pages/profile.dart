...
import 'package:we_deliver_restaurant/widgets/list.dart';
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text(widget.user.name?.toUpperCase() ?? 'Not register',
                        style: TextStyle(
                          fontSize: 20.0,
                        ),
                      ),
                      SizedBox(height: 10.0),
                      Text(widget.user.phone ?? 'Not register',
                        style: TextStyle(
                          fontSize: 20,
                          color: Colors.grey),
                      ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      CustomListTile(
                        icon: Icons.email,
                        text: widget.user.email ?? 'Not register',
                      ),
                      Divider(
                        height: 10.0,
                        color: Colors.grey,
