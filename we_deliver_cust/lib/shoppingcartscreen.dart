...
import 'package:we_deliver_cust/food.dart';
import 'package:we_deliver_cust/foodscreen.dart';
import 'package:we_deliver_cust/payment.dart';
...
class _ShoppingCartScreenState extends State<ShoppingCartScreen> {
                              ...
                              children: [
                                Container(
                                    ...
                                    child: CachedNetworkImage(
                                      imageUrl:
                                          "https://itschizo.com/wedeliver2/images/food_images/${cartList[index]['imagename']}.jpg",
                                      fit: BoxFit.cover,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Text(
                          "Delivery Charge RM " + delcharge.toStringAsFixed(2),
                          style: TextStyle(fontSize: 16),
                        ),
                        Text(
  ...
  void _loadCart() {
    http.post("https://itschizo.com/wedeliver2/php/load_cart.php", body: {
  ...
  void _deleteCart(int index) {
    http.post("https://itschizo.com/wedeliver2/php/delete_cart.php", body: {
      "email": widget.user.email,
      "foodid": cartList[index]['foodid'],
    }).then((res) {
      print(res.body);
