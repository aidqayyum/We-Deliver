...
class _FoodScreenDetailsState extends State<FoodScreenDetails> {
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    ...
                    child: Hero(
                      tag:
                          "https://itschizo.com/wedeliver2/images/food_images/${widget.food.foodimg}.jpg",
                      child: Image(
                        image: NetworkImage(
                          "https://itschizo.com/wedeliver2/images/food_images/${widget.food.foodimg}.jpg",
                        ),
  ...
  void _orderFood() {
    http.post("https://itschizo.com/wedeliver2/php/insert_cart.php", body: {
