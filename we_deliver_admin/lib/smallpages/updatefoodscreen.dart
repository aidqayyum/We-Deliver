...
class UpdateFoodScreen extends StatefulWidget {
  ...
  const UpdateFoodScreen({Key key, this.admin, this.food}) : super(key: key);
  @override
...
class _UpdateFoodScreenState extends State<UpdateFoodScreen> {
  ...
  void initState() {
    ...
    _fooddesccontroller.text = widget.food.fooddesc;
  }
  ...
  void _onUpdateFood() {
    ...
    http.post("https://itschizo.com/wedeliver/php/update_food.php", body: {
