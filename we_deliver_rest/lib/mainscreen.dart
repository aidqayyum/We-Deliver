...
import 'package:we_deliver_rest/food.dart';
import 'package:we_deliver_rest/newfoodscreen.dart';
import 'package:we_deliver_rest/restaurant.dart';
import 'package:we_deliver_rest/updatescreen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  void _onSetAvailability(int i, String st) {
    http.post("https://itschizo.com/wedeliver2/php/set_foodsavail.php",
  ...
  void _setStoreStatus(String st) {
    http.post("https://itschizo.com/wedeliver2/php/set_store_status.php",
